...
python ./training/train_tum.py --cfg=cfgs/tum_2_2_fast_aspp.yaml --name=tmu_model --dataset_dir=data/tum --restore=checkpoints/tum/inference_result_240_320_2_2/_stage_2.ckpt
