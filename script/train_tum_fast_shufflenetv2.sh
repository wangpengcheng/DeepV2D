...
python ./training/train_tum.py --cfg=cfgs/tum_2_2_fast_shufflev2.yaml --name=tmu_model --dataset_dir=data/tum --restore=checkpoints/tum/tmu_model_shufflenetv2/_stage_2.ckpt
